...
const Home = (props) => {
    ...
    return (
      <>
        {showSuccess && <div className="Home-fade-div Home-username-text"> <img src={successful_beaver} className="Home-fade-image" /> <div>Hi {new_username}!</div></div>}
        {showFailure && <div className="Home-fade-div Home-username-text"> <img src={unsuccessful_beaver} className="Home-fade-image" /> <div>{new_username} is not valid</div></div>}
              ...
              <div className="Home-two-divs">
                  ...
                  <div className="Home-main-rounded-div Home-multiplayer-party">
                      ...
                      {/* <Link to={`/race/${roundID}`}> */}
                          <button className="u-pointer Home-button Home-create-party-button" onClick={createMultiplayerRound}>
                              Create River
                          </button>
                      {/* </Link> */}
